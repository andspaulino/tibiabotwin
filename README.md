...
- O perfil `cavebot` conecta um waypoint `flag0` ao loop somente em `--observe-only`: o log mostra a intenção de movimento e o clique simulado. Fora desse modo, o Cavebot não encaminha ações ao executor.
